  ...
  <div class="grain flex flex-col items-center justify-center min-h-screen p-8 relative overflow-hidden">
    ...
    <div class="text-center mb-16 relative z-10">
      <div class="flex items-center justify-center gap-3 mb-4">
        <svg class="w-8 h-8 text-amber-warm" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <h1 class="font-display text-3xl font-300 tracking-tight text-ink-100 mb-2">
        Book Viewer
      </h1>
      <p class="font-display text-sm text-ink-500 font-300 tracking-wide">
        Open a folder of markdown files to start reading
      </p>
    </div>
